...
class HotModelsHotlockSecurityInfo extends FormatageModelsSection {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, StylesGroupManager $styles_group_manager) {
    ...
    $this->pluginDefinition->set('icon', $this->pathResolver->getPath('module', 'hot_models') . "/icones/sections/hot_models_security_info.png");
  }
  ...
  public function defaultConfiguration() {
    return parent::defaultConfiguration() + [
      'css' => '',
      'region_css_security_title' => 'bp_hero',
      'region_css_security_text' => 'h4 font-weight-bold',
      'hmhsi' => [
        'builder-form' => true,
        'info' => [
          'title' => 'Contenu',
