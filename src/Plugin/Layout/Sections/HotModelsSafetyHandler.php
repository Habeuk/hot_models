 ...
 *
 * @Layout(
 *  id = "hot_models_hotlock_safetyhandler",
 *  label = @Translation("safetyhandler"),
 *  category = @Translation("hot_models"),
 *  path = "layouts/sections",
 *  template = "hot-models-hotlock-safetyhandler",
 *  library = "hot_models/hot-models-hotlock-safetyhandler",
 *  regions = {
 *       "title" = {
...
class HotModelsSafetyHandler extends FormatageModelsSection {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, StylesGroupManager $styles_group_manager) {
    ...
    $this->pluginDefinition->set('icon', $this->pathResolver->getPath('module', 'hot_models') . "/icones/sections/hot-models-hotlock-safetyhandler.png");
  }
